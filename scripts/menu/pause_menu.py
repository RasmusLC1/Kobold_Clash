...
class Pause_Menu(Menu):
    ...
    def Init_Buttons(self):
        ...
        self.Generate_Button((width - self.button_size_x // 2, self.button_size_y * 4.5), (self.button_size_x, self.button_size_y), 'Save and Quit to Main Menu', 'return_main_menu', True)
        self.Generate_Button((width - self.button_size_x // 2, self.button_size_y * 6.5), (self.button_size_x, self.button_size_y), 'Save & Quit To Desktop', 'exit_game_save')
