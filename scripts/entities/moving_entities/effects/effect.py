...
class Effect():
    ...
    def Render_Effect(self, surf, offset=(0, 0)):
        ...
        image.set_alpha(179)
        surf.blit(pygame.transform.flip(image, self.entity.animation_handler.flip[0], False), (self.entity.pos[0] - offset[0] + self.entity.anim_offset[0], self.entity.pos[1] - offset[1] - 5))
