...
ENEMY_STATS = {
    ...
    keys.earth_elemental:         {keys.health: 80, keys.souls: 30, keys.max_weapon_charge: 2.0,  keys.strength: 5, keys.speed: 2, keys.agility: 2, keys.intelligence: 8, keys.stamina: 2, keys.behavior: HIT_AND_RUN,},
