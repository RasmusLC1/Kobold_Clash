...
ENEMY_STATS = {
    ...
    keys.earth_elemental:         {keys.health: 40, keys.souls: 30, keys.max_weapon_charge: 2.0,  keys.strength: 5, keys.speed: 2, keys.agility: 2, keys.intelligence: 8, keys.stamina: 2, keys.behavior: keys.hit_and_run, keys.ability: keys.dash},
