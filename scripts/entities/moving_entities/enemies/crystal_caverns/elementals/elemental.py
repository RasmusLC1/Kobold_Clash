...
class Elemental(Enemy):
    def __init__(self, game, pos, type, health, strength, max_speed, agility, intelligence, stamina, max_weapon_charge, soul_value, idle_animation, run_animation, attack_animation, size = (32, 32), attack_speed = (0.5, 0.8)):
        super().__init__(game, pos, type, health, strength, max_speed, agility, intelligence, stamina, max_weapon_charge, keys.elemental, soul_value, idle_animation, run_animation, attack_animation, size, attack_speed)
