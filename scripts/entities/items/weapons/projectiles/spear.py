...
class Spear(Projectile):
    def __init__(self, game, pos, damage_type = 'slash'):
        super().__init__(game, pos, type=keys.spear, damage=3, speed=6, range=8, max_charge_time=50, weapon_class='two_handed_melee', effect=damage_type, shoot_distance=30, attack_types=[keys.stab], max_animation=0)
